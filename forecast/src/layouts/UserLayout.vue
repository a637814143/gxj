...
const rawMenuItems = [
  ...
  { label: '空间分布', name: 'spatialAnalysis', path: '/spatial-analysis' },
...
const quickActionConfigs = computed(() => [
  ...
  { key: 'spatial-analysis', label: '空间分布', icon: '🗺️', type: 'route', name: 'spatialAnalysis', accent: 'forest' },
