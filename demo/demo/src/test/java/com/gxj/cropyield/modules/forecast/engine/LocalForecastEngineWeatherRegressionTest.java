        ...
        List<ForecastEngineRequest.HistoryPoint> history = List.of(
            new ForecastEngineRequest.HistoryPoint(
                ...
                Map.of(
                    ...
                    "winterDormancyAvgMinTemperature", 4.0,
                    "springRipeningAvgMaxTemperature", 22.0,
                    "springRipeningTotalSunshineHours", 620.0
                )
            ),
            new ForecastEngineRequest.HistoryPoint(
                "2021",
                ...
                Map.of(
                    ...
                    "winterDormancyAvgMinTemperature", 4.2,
                    "springRipeningAvgMaxTemperature", 23.5,
                    "springRipeningTotalSunshineHours", 640.0
                )
            ),
            new ForecastEngineRequest.HistoryPoint(
                "2022",
                ...
                Map.of(
                    ...
                    "winterDormancyAvgMinTemperature", 4.5,
                    "springRipeningAvgMaxTemperature", 24.5,
                    "springRipeningTotalSunshineHours", 660.0
                )
            )
        );
