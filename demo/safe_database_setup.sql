...
WHERE r.name = 'FARMER' 
AND p.name IN ('crop_data:read', 'prediction:read');
...
AND p.name IN (
    'crop_data:read', 'crop_data:create', 'crop_data:update', 'crop_data:import', 'crop_data:export',
...
(2, '水稻', '黑龙江省', 2024, 1850.25, '±50.8', 0.92),
(3, '玉米', '河北省', 2024, 1600.00, '±40.3', 0.88);
